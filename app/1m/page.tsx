...
export default function Home() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center justify-center relative overflow-hidden bg-gradient-to-br from-pink-100 to-blue-100 py-10">
      ...
      <div className="relative mb-12 animate-[fadeIn_1.5s_ease-in] mt-6">
      ...
      <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg w-[90%] max-w-md mb-8 animate-[fadeIn_2s_ease-in]">
        <div className="text-center mb-3">
          <p className="text-gray-700 font-medium">เพลงรักทุกเพลงต่อจากนี้</p>
          <p className="text-gray-500 text-sm">จะให้เป็นของเอยคนเดียว</p>
          <p className="text-gray-400 text-xs mt-1">🩷 เท่าน้านนนน 🩷</p>
        </div>
      ...
      >
        ...
        <p className="text-gray-700 mb-3">
          เห้ยครบรอบ 1 เดือนละเร้วดีน่อ 1 เดือนที่ผ่านมาดีโคตรรๆ เลยนะ กุโคตรจะมีความสุขเลย 
          ได้แลกเปลี่ยนอะไรหลายๆ อย่าง ได้ทำอะไรใหม่ๆ ถึงจะมีไม่เข้าใจกันบ้าง ผิดใจกันบ้าง ทะเลาะกันบ้าง แต่มันก้น่าจะทำให้เราเข้าใจกันมากขึ้น กุว่าเราคงเข้าใจกันและกันมากขึ้นจากแต่ก่อนมากเลยเนาะ 😆
        </p>
        <p className="text-gray-700 mb-3">
          กุดีใจนะ แบบดีใจมากกๆ ที่มีมึงเป็นแฟนอะ หลังจากนี้ถ้ามีอะไรให้ผิดใจกันก้หวังไว้ว่าจะไม่ปล่อยกันและผ่านมันไปด้วยกันได้นะ อยากอยู่ด้วยไปนานๆ เล้ยยย รักแฟนมากๆ เลยนะะ <span className="inline-block animate-bounce text-red-500">💕</span>
        </p>
        <p className="text-gray-700 text-right font-medium">จุ๊บจุ๊บบ 😘,</p>
        <p className="text-gray-700 text-right">จาก แฟนที่รักมึงโคตรๆ 🫶🏻</p>
      </div>
      ...
      <div className="bg-white/80 backdrop-blur-sm p-6 rounded-2xl shadow-lg w-[90%] max-w-md mb-12 animate-[fadeIn_3s_ease-in]">
        ...
        <p className="text-center text-gray-700">Glad to have you, Oei. <span className="inline-block animate-bounce text-red-500">❤️</span></p>
      </div>
        </>
      )}
      {/* Footer */}
